  ...
  return (
    ...
    <div>
      ...
      <p class="mt-4 max-w-xs leading-normal text-gray-500 dark:text-gray-400">
        Hobbyist software developer and a tinkerer.
      </p>
      ...
      <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
        <li class="mr-5 text-xs">
          <a
            ...
            href="https://github.com/Bhavya-Ahir"
            target="_blank"
            rel="noreferrer"
          >
        ...
        {/* <li class="mr-5 text-xs">
          <a class="block hover:text-slate-200" href="https://twitter.com/bchiang7" target="_blank" rel="noreferrer">
            <span class="sr-only">Twitter</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 248 204" fill="#01e2c7" class="h-6 w-6" aria-hidden="true">
        ...
        <li class="mr-5 text-xs">
          <a
            class="block hover:text-slate-200"
            href="https://www.linkedin.com/in/bhavyaahir1729/"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <li class="mr-5 text-xs">
          <a
            class="block hover:text-slate-200"
            href="mailto:bhavyaahir1729@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
            <span class="sr-only">LinkedIn</span>
